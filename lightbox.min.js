...
!(function(a, b) {
	'function' == typeof define && define.amd
		? define([ 'jquery' ], b)
		: 'object' == typeof exports ? (module.exports = b(require('jquery'))) : (a.lightbox = b(a.jQuery));
})(this, function(a) {
	function b(b) {
		(this.album = []),
	...
	return (
		...
		(b.prototype.enable = function() {
			...
			a(
				'body'
			).on('click', 'a[rel^=lightbox], area[rel^=lightbox], a[data-lightbox], area[data-lightbox]', function(c) {
